...
<head>
    ...
    <link rel="shortcut icon" type="x-icon" href="<?php echo base_url('landing/'); ?>img/logo-pas.png">
    ...
    <div class="container-fluid bg-white sticky-top" >
        <div class="container">
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-2 py-lg-0">
                <img src="<?php echo base_url('landing/'); ?>img/logopink.png" style="width: 35px;" alt="">
        ...
        <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="<?php echo base_url('landing/'); ?>img/bidan.jpeg" alt="Image">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-7 text-center">
                                    <p class="fs-4 text-white animated zoomIn">Selamat datang di <br> <strong class="text-light">Praktek Mandiri Bidan Yeni Mariana, A.Md. Keb.</strong></p>
                                    <!-- <h1 class="display-1 text-dark animated zoomIn">Organic & Quality Tea Production</h1> -->
                                    <a href="<?= base_url('home/daftar') ?>" class="btn btn-light rounded-pill py-3 px-5 animated zoomIn">Daftar Antrian >></a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row g-5">
                <div class="col-lg-6">
                    <div class="row g-3">
                        <div class="col-6 text-end">
                            <img class="img-fluid bg-white w-100 mb-3 wow fadeIn" data-wow-delay="0.1s" src="<?php echo base_url('landing/'); ?>img/tempat2.jpeg" alt="">
                            <img class="img-fluid bg-white w-50 wow fadeIn" data-wow-delay="0.2s" src="<?php echo base_url('landing/'); ?>img/logo-wp.png" alt="">
                        </div>
                        <div class="col-6">
                            <img class="img-fluid bg-white w-50 mb-3 wow fadeIn" data-wow-delay="0.3s" src="<?php echo base_url('landing/'); ?>img/logo-wp.png" alt="">
                            <img class="img-fluid bg-white w-100 wow fadeIn" data-wow-delay="0.4s" src="<?php echo base_url('landing/'); ?>img/tempat1.jpeg" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    <div class="section-title">
                        ...
                        <h1 class="text-dark">Sekilas tentang Praktek Bidan Yeni</h1>
                    </div>
                    <div class="row g-3 mb-4">
                        <div class="col-sm-4">
                            <img class="img-fluid bg-white w-100" src="<?php echo base_url('landing/'); ?>img/bidan.jpeg" alt="">
                        </div>
                        <div class="col-sm-8">
                            <!-- <h5>Sejarah</h5> -->
                            <p class="mb-0">Praktek Mandiri Bidan Yeni Mariana, A.Md. Keb., Ns didirikan dengan visi untuk memberikan perawatan medis berkualitas tinggi dan berorientasi pasien kepada masyarakat.</p>
                        </div>
                    </div>
    ...
    <div class="container-fluid product py-5 my-5" id="product">
        <div class="container py-5">
            <div class="section-title text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                ...
                <h1 class="display-6">Praktek mandiri Bidan Yeni melayani</h1>
            </div>
            <div class="owl-carousel product-carousel wow fadeInUp" data-wow-delay="0.5s">
                <a href="" class="d-block product-item rounded">
                    <img src="<?php echo base_url('landing/'); ?>img/ibu.jpeg" alt="">
                    <div class="bg-white shadow-sm text-center p-4 position-relative mt-n5 mx-4">
                        <h4 class="text-dark">Layanan Ibu Hamil</h4>
                        <span class="text-body">pemeriksaan rutin selama kehamilan, seperti pemeriksaan tekanan darah, berat badan, dan pemeriksaan fisik untuk memantau perkembangan janin dan kesehatan ibu hamil.</span>
                    </div>
                </a>
                <a href="" class="d-block product-item rounded">
                    <img src="<?php echo base_url('landing/'); ?>img/imunisasi.jpeg" alt="">
                    <div class="bg-white shadow-sm text-center p-4 position-relative mt-n5 mx-4">
                        <h4 class="text-dark">Imunisasi</h4>
                        <span class="text-body">Memberikan imunisasi kepada ibu hamil dan bayi sesuai dengan jadwal yang ditentukan.</span>
                    </div>
                </a>
                <a href="" class="d-block product-item rounded">
                    <img src="<?php echo base_url('landing/'); ?>img/anak.jpeg" alt="">
                    <div class="bg-white shadow-sm text-center p-4 position-relative mt-n5 mx-4">
                        <h4 class="text-dark">Pemeriksaan Anak dan Balita</h4>
                        <span class="text-body">pemeriksaan dan konseling kesehatan anak balita, termasuk pemberian vaksin.</span>
                    </div>
                </a>
                <a href="" class="d-block product-item rounded">
                    <img src="<?php echo base_url('landing/'); ?>img/umum.jpeg" alt="">
                    <div class="bg-white shadow-sm text-center p-4 position-relative mt-n5 mx-4">
                        <h4 class="text-dark">Layanan Kesehatan Umum</h4>
                        <span class="text-body">pelayanan yang tersedia untuk masyarakat secara umum dalam upaya menjaga dan meningkatkan kesehatan mereka.</span>
                    </div>
                </a>
                <a href="" class="d-block product-item rounded">
                    <img src="<?php echo base_url('landing/'); ?>img/kb.jpeg" alt="">
                    <div class="bg-white shadow-sm text-center p-4 position-relative mt-n5 mx-4">
                        <h4 class="text-dark">Pelayanan Keluarga Berencana</h4>
                        <span class="text-body">memberikan informasi dan pelayanan tentang kontrasepsi dan perencanaan keluarga. </span>
                    </div>
                </a>
            </div>
        </div>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="row g-5">
                        <div class="col-md-4 text-center wow fadeInUp" data-wow-delay="0.3s">
                            ...
                            <p class="mb-2">bidanyeni@gmail.com</p>
                        ...
                        <div class="col-md-4 text-center wow fadeInUp" data-wow-delay="0.5s">
                            ...
                            <p class="mb-2">Jl. Urip Sumoharjo No.78 </p>
                            <p class="mb-0">Kec. Tanggul, Kabupaten Jember, Jawa Timur</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-map-marker-alt text-primary me-3"></i>Jl. Urip Sumoharjo No.78 Kec. Tanggul, Kabupaten Jember, Jawa Timur</p>
                    <p class="mb-2"><i class="fa fa-phone-alt text-primary me-3"></i>+62 345 67890</p>
                    <p class="mb-2"><i class="fa fa-envelope text-primary me-3"></i>bidanyeni@gmail.com</p>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <h6 class="text-light">16:00 - 20:00</h6>
                </div>
                <!-- <div class="col-lg-3 col-md-6">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    &copy; <a class="fw-medium" href="#">SABINE</a>, All Right Reserved.
                </div>
